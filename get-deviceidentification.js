module.exports = function(RED) {
    function GetDeviceIdentification(config) {  
        ...
        node.on('input', function(msg) {
            ...
            // Überprüfen und Aktualisieren von deviceAlias, falls vorhanden und vom richtigen Typ
            ...
            let url = `http://${ip}/iolink/v1/devices/${devicealias}/identification`;
    ...
    RED.nodes.registerType("get-deviceidentification", GetDeviceIdentification);
}
