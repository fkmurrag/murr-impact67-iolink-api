module.exports = function(RED) {
    function GetProcessData(config) {  
        ...
        node.on('input', function(msg) {
			...
			if (typeof devicealias !== "string")  node.error("msg.deviceAlias is wrong formatted, should be string");
             ...
             let url= `http://${ip}/iolink/v1/devices/${devicealias}/processdata/getdata/value?format=byteArray`;
    ...
    RED.nodes.registerType("get-processdata", GetProcessData);
}
