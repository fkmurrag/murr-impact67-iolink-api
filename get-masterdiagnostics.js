module.exports = function(RED) {
    function GetMasterDiagnostics(config) {  
        RED.nodes.createNode(this, config);
        var node = this;

        let ip = config.ip;
        let url = `http://${ip}/iolink/v1/vendor/masters/1/diagnostics/value`;
        ...
        node.on('input', function(msg) {
			...
			url = `http://${ip}/iolink/v1/vendor/masters/1/diagnostics/value`;
    ...
    RED.nodes.registerType("get-masterdiagnostics", GetMasterDiagnostics);
}
