module.exports = function(RED) {
    function GetMasterEventLog(config) {  
        RED.nodes.createNode(this, config);
        var node = this;

        let ip = config.ip;
        let url = `http://${ip}/iolink/v1/gateway/events`;
        ...
        node.on('input', function(msg) {
			...
			url = `http://${ip}/iolink/v1/gateway/events`;
    ...
    RED.nodes.registerType("get-mastereventlog", GetMasterEventLog);
}
